...
DATA_DIR=$(realpath "${SCRIPT_DIR}/../../../../Data/Train")
...
train_datasets="[${DATA_DIR}/SocialRL_Train_V2_SocialR1.parquet]"
test_datasets="[${DATA_DIR}/SocialRL_Test_V2_SocialR1.parquet]"
